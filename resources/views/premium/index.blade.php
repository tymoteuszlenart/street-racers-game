<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-accent-orange leading-tight">
            {{ __('Premium') }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-racing-800 border border-accent-orange/40 rounded-lg p-6">
                ...
                <div class="space-y-4">
                    @foreach ($products as $product)
                        ...
                        <div class="bg-racing-700 border border-racing-600 rounded-lg p-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                            <div>
                                <h3 class="text-lg font-bold text-accent-orange">{{ $product->name }}</h3>
                            ...
                            <div class="shrink-0">
                                ...
                                @else
                                    <form method="POST" action="{{ route('premium.checkout', $product) }}">
                                        @csrf
