    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-racing-800 border border-racing-600 rounded-lg p-6 space-y-4">
                ...
                <a href="{{ route('shop.index') }}" class="inline-block text-accent-neon hover:underline text-sm">
                    {{ __('Back to shop') }}
                </a>
                <a href="{{ route('dashboard') }}" class="inline-block text-accent-orange hover:underline text-sm ms-4">
                    {{ __('Dashboard') }}
                </a>
            </div>
        </div>
