                    ...
                    <div class="space-y-4">
                        ...
                        <div class="pt-4 border-t border-racing-600 space-y-2">
                            <div class="flex flex-wrap gap-2">
                                ...
                                @else
                                    <button type="button" disabled title="{{ __('Reach level :level', ['level' => config('game.mechanic.unlock_level', 10)]) }}" class="px-3 py-1 text-xs rounded bg-racing-700 text-gray-500 border border-racing-600 cursor-not-allowed">{{ __('Tune') }} ({{ __('Lvl :level', ['level' => config('game.mechanic.unlock_level', 10)]) }})</button>
                                @endif
